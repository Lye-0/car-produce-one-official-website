...
for a,b in [(-140,-15),(-2,20)]:
 ...
 for side in [-1,1]:
  x=X+side*(HALF+1)
  box('JT.Walkway '+str(a)+' '+str(side),(x-1,a,-.22),(x+1,b,-.02),pavement,city)
...
box('JT.Stop line',(X-5,-23.5,-.105),(X+1.8,-23.15,-.101),paint,city)
...
def sample(t):
 if t<=approach:return Vector((X,start.y+travel(t,approach,V0,VC),origin.z)),math.pi/2
