...
export const PORTAL_SCREEN_START = 2340;
export const PORTAL_SCREEN_END = 2700;
...
export function monitorProjection(
  rows: TrackingFrame[],
  frame: number,
  view: Viewport,
  ...
  const normalized = sampleQuad(rows, frame),
    terminal = sampleQuad(rows, PORTAL_SCREEN_END);
